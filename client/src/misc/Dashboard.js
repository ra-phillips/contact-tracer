...
import {Badge, Button,Card,Navbar,Nav,Table,Container,Row,
  Col,Form,OverlayTrigger,Tooltip,} from "react-bootstrap";
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Client Visits</p>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      ...
                      <Card.Title as="h4">55</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Log</p>
